...
<table>
  <tr>
    <td width="50%">
      ...
      <br /><sub>Private career intelligence that stays on the device.</sub>
    </td>
    <td width="50%">
      ...
      <br /><sub>A permission-aware desktop agent with an inspectable control plane.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%">
